export const houseHackModels = [
  {
    name: "Rent by the room",
    short: "Live in one bedroom, rent out the rest.",
    description:
  ...
  },
  {
    ...
    short: "A self-contained rental under your own roof.",
    description:
  ...
  },
  {
    ...
    short: "Live in one unit of a duplex, triplex, or fourplex.",
    description:
