...
export type Hub = {
  ...
  blurb: string;
  intro: string[];
  /** Optional aside — an accent-bordered callout, rendered separately from the flowing intro. */
  note?: string;
  /** Optional compliance disclaimer — the strong disclaimer-callout treatment, not the softer note style. */
  disclaimer?: string;
  pillar: string;
  sections: HubSection[];
...
export const hubs: Hub[] = [
  {
    ...
    note: "One note on language: house hacking is not the same thing as coliving. Coliving is a related but more advanced model, built around shared living as the product rather than a byproduct of owning a bigger property. Almost nobody starts there, and nothing on this page assumes you will.",
  ...
  },
  {
    ...
    note: "If you're actively touring, come back for the walkthrough checklist — it's built to catch what photos and a quick visit don't.",
  ...
  },
  {
    ...
    note: "None of this tells you whether you'll like living in a property. It tells you whether the math holds up — which is the part worth eliminating bad options on before you let yourself get emotionally attached to a good-looking listing.",
  ...
  },
  {
    ...
    note: "None of these are more \"legitimate\" than a standard lease. They're different tools for different properties and different amounts of hands-on involvement — read through and see which matches how much you actually want to be doing.",
  ...
  },
  {
    ...
    note: "If you're earlier in the process, the other seven hubs will matter more right now. Come back here once you're living it, or once you're starting to think about what comes after the first one.",
